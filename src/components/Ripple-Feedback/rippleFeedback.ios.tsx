...
interface RippleFeedbackState {
    maxOpacity: number;
    opacityBackgroundValue: any;
    diameter: number;
    opacityRippleValue: any;
    scaleValue: any;
    pressX?: number;
    pressY?: number;
    rippleColor: string;
...
class RippleFeedbackIOS extends PureComponent<RippleFeedbackProps, RippleFeedbackState> {
    longPress: boolean;
    ...
    constructor(props, context) {
        ...
        const maxOpacity = 0.12; // todo fix
        ...
        this.state = {
            ...
            maxOpacity,
            rippleColor: props.color as string,
    ...
    render() {
        ...
        const parent = React.Children.only(children) as React.ReactElement<any>;
